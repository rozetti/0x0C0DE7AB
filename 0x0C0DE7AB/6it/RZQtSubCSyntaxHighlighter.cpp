...
RZQtSubCSyntaxHighlighter::RZQtSubCSyntaxHighlighter(QTextDocument *parent) : QSyntaxHighlighter(parent)
{
...
void RZQtSubCSyntaxHighlighter::highlightBlock(const QString &text)
{
